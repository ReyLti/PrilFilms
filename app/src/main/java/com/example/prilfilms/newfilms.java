...
public class newfilms extends Activity {
    TextView tvInfo;
    EditText tvName;
    newfilms.MyTask mt;
    newfilms.MyTaskN mtn;
    newfilms.MyTaskTF mttf;
    ListView lvMain;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_newfilms);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
        lvMain = (ListView) findViewById(R.id.lvMain);
        lvMain.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
        mt = new newfilms.MyTask();
        mt.execute();
    }
    public void onclick(View v) {
        mtn = new newfilms.MyTaskN();
...
//                        sb.append("\r\n : " +value);
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            super.onPostExecute(result);
            newfilms.ClAdapter clAdapter=new newfilms.ClAdapter(tvInfo.getContext(),result);
//            lvMain = (ListView) findViewById(R.id.lvMain);
